<?php
    ...
    //process ng pag add ng acc
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $username = $_POST['username'];
        $password = password_hash($_POST['password'], PASSWORD_DEFAULT); //pag hash ng pass sa db
        $role = 'employee';  //automatic na employee role ng inadd na acc.

        ////checking kung nag eexist na yung username bawal same username
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body">
                <div class="div d-flex align-items-center justify-content-between mt-2 mx-2">
                    <h4 class="card-title m-0">ADD NEW EMPLOYEE ACCOUNT</h4>
                    <a href="employee.php">
                ...
                <div class="px-5 ">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10 offset-sm-2">
                            <button type="submit" class="btnn mb-5" name="update">Add Employee Account</button>
                        </div>
                    </div>
